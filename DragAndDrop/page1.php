...
<link href="bower_components/dragula.js/dist/dragula.css" rel="stylesheet" type="text/css"/>
<link href="bower_components/dragula.js/example/example.css" rel="stylesheet" type="text/css"/>
  ...
  <div class='parent'>
    ...
    <div class='wrapper'>
      <div id='left-defaults' class='container'>
        ...
        <div class='image-thing'><img src='bower_components/dragula.js/resources/icon.svg' onerror='this.src="resources/icon.png"' alt='dragula'/></div><sub>(You can still click on links, as usual!)</sub>
        </div>
      </div>
      <div id='right-defaults' class='container'>
        ...
        <div>Make sure to check out the</div>
      </div>
    </div>
    <pre>
      <code>
