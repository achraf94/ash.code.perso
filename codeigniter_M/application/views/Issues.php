...
<div class="w3-row cen" style="padding-left: 18%;">
    ...
    <a href="<?php echo base_url(); ?>index.php/c_raid/issue">
        <div class="leWidth w3-col w3-container w3-yellow w3-margin w3-bottombar w3-border-black">
            <h2>ISSUES</h2> 
        </div>
    </a>
            ...
            <h4 class="w3-padding  w3-round-xxlarge textOpen">Open <span class="w3-right nbropen"></span></h4> <div class="stuck">
                ...
                foreach ($issues as $row) {
                    ...
                    if ($row->Status_ID == 1) {
                        $i++;
                        ?>
                        <div class="w3-border w3-padding" id="card<?php echo $row->Issue_ID; ?>" id-data="<?php echo $row->Issue_ID; ?>">
                            <div class="w3-round-large <?php echo setPriority($row->Priority); ?>  w3-padding w3-round-large w3-margin">
                                <header>
                                    <a href="#myCarousel<?php echo $row->Issue_ID; ?>" data-slide="prev"><span class="w3-left glyphicon glyphicon-menu-left majmo "></span></a>
                                    <a href="#myCarousel<?php echo $row->Issue_ID; ?>" data-slide="next"><span class="w3-right glyphicon glyphicon-menu-right majmo " href="#myCarousel<?php echo $row->Risk_ID; ?>" data-slide="next"></span></a>
                                    <br><br>
                                </header>
                                <header >
