...
<div class="w3-container  container" style="width: 100%;">
    <div class="row">
        ...
        <div class="col-md-6 w3-center ">
            <h4 class="w3-padding w3-round-xxlarge textProgres">Pending <span class="w3-right nbrrpo"></span></h4>
            <div class="stuck">
                <?php
                $j = 0;
                foreach ($decision as $row) {

                    if ($row->Status == "Pending") {
                        $j++;
                        ?>
                        <div class="w3-border w3-padding" id="card<?php echo $row->Decision_ID; ?>" id-data="<?php echo $row->Decision_ID; ?>">
                            <div class="w3-round-large Mycard w3-padding w3-margin">
                                <header class="w3-margin-top">

                                    <span class="w3-center"><?php echo $row->Decision_Forum; ?></span>
                                    <br>
                                </header>
                                <hr>
                                <div class="w3-container w3-center">
                                    <?php echo $row->Decision_Descr; ?>
                                </div>
                                <hr>
                                <header class="w3-margin-bottom">
                                    <span class="w3-left"> <?php echo $project[$row->Project_ID]; ?></span>
                                    <span class="w3-right"><?php echo $row->Decision_Date; ?></span>
                                </header>
                                <br>
                            </div>
        ...
        <div class="col-md-6 w3-center ">
            <h4 class="w3-padding w3-round-xxlarge textClose">Made <span class="w3-right nbrclose"></span></h4>
            <div class="stuck">
                <?php
                $k = 0;
                foreach ($decision as $row) {
