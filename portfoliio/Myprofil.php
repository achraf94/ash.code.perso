...
<html>
    ...
    <body class="w3-black">
        ...
        <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
            ...
            <img src="img/ash.jpg" style="width:100%">
        ...
        <div class="w3-padding-large" id="main">
            ...
            <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
                <h1 class="w3-jumbo"><span class="w3-hide-small">I'm</span> TAJANI Achraf AKA Don Mayrinho.</h1>
                <p>Developper and Web Designer.</p>
                <img src="img/ash.jpg" alt="boy" class="w3-image" width="400" height="400">
            </header>
            ...
            <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
                ...
                <p>
                    Achraf Tajani Alternant chez MB SCIS autant que charge de projet IT et SCM.
                    (...)
